 ...
 */
let DiagnosticsPrompts = class DiagnosticsPrompts {
    factoryState;
     ...
     */
    async dailyRiskBriefing(args, context) {
...
`;
     ...
     */
    async incidentResponsePlan(args, context) {
        context.logger.info('Generating incident response plan');
        const machineId = args.machineId || 'M-12';
        const zoneId = args.zoneId || 'zone-1';
        const orderId = args.orderId || 'ORD-2026-001';
...
`;
     ...
     */
    async shiftHandoverReport(args, context) {
...
], DiagnosticsPrompts.prototype, "dailyRiskBriefing", null);
__decorate([
    Prompt({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], DiagnosticsPrompts.prototype, "incidentResponsePlan", null);
__decorate([
    Prompt({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], DiagnosticsPrompts.prototype, "shiftHandoverReport", null);
DiagnosticsPrompts = __decorate([
    Injectable({ deps: [FactoryStateService] }),
    __metadata("design:paramtypes", [FactoryStateService])
], DiagnosticsPrompts);
export { DiagnosticsPrompts };
//# sourceMappingURL=diagnostics.prompts.js.map