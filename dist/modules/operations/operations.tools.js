 ...
 */
let OperationsTools = class OperationsTools {
    factoryState;
     ...
     */
    async coordinateIncidentResponse(input, context) {
     ...
     */
    async reassignProductionBatch(input, context) {
     ...
     */
    async adjustEnvironmentalSettings(input, context) {
     ...
     */
    async createMaintenanceWorkOrder(input, context) {
     ...
     */
    async checkSparePartAvailability(input, context) {
     ...
     * Notify manager
     */
    async notifyManager(input, context) {
     ...
     */
    async updateDeliveryEstimate(input, context) {
     ...
     */
    async createProductionLine(input, context) {
...
], OperationsTools.prototype, "coordinateIncidentResponse", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "reassignProductionBatch", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "adjustEnvironmentalSettings", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "createMaintenanceWorkOrder", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "checkSparePartAvailability", null);
__decorate([
    Tool({
        name: 'notifyManager',
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "notifyManager", null);
__decorate([
    Tool({
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "updateDeliveryEstimate", null);
__decorate([
    Tool({
    ...
    __metadata("design:returntype", Promise)
], OperationsTools.prototype, "createProductionLine", null);
OperationsTools = __decorate([
    Injectable({ deps: [FactoryStateService] }),
    __metadata("design:paramtypes", [FactoryStateService])
], OperationsTools);
export { OperationsTools };
//# sourceMappingURL=operations.tools.js.map